 ...
 *  USA
 *
 *  $Id: m_challenge.c,v 1.57 2005/07/16 12:19:43 michael Exp $
 */
            ...
            int parc, char *parv[])
{
  ...
  if (*parv[1] == '+')
  {
				   ...
				   )) == NULL)
    {
      ...
      log_failed_oper(source_p, source_p->localClient->auth_oper);
      return;
    }
    ...
    ilog(L_TRACE, "OPER %s by %s!%s@%s",
	 ...
	 source_p->host);
    log_oper(source_p, source_p->localClient->auth_oper);
